        ...
        <div class="block">
            ...
            <div class="block-body">
                <form action="processLogin" method="post">
                    <label>用户名</label>
                    <s:textfield type="text" name="user.userAccount" cssClass="span12"/>
                    <label>密码</label>
                    <s:textfield type="password" name="user.userPassword" cssClass="span12"/>
                    
                    		          		
		          	<s:reset  theme="simple" value="重  填" cssClass="btn btn-primary"/>
