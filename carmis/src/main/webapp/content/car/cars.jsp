...
<body>
   ...
   <button class="btn">总数：<s:property value="carCount"/></button>
	...
	<form id="tab" action="cars" method="post" style="float:right;">
	<table><tr>
    ...
    <table class="table">
      ...
      <tbody>
        <s:iterator value="cars" status="index">
          ...
          <td>
             <a href="showChangeCar?carId=<s:property value="carId"/>" role="button" ><i class="icon-pencil"></i></a></td> 
          <td>    <a href="carExpenses?carId=<s:property value="carId"/>" role="button" ><i class="icon-info-sign"></i></a>
          </td>
        </tr>
        </s:iterator>
