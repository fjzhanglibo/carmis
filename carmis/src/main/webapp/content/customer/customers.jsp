...
<body>
   ...
   <button class="btn">总数：<s:property value="customerCount"/></button>
  
	<form id="tab" action="customers" method="post" style="float:right;">
	<table><tr>
    ...
    <table class="table">
      ...
      <tbody>
        <s:iterator value="customers" status="index">
          ...
          <td>
             <a href="showChangeCustomer?customerId=<s:property value="customerId"/>" role="button" ><i class="icon-pencil"></i></a></td> 
          <td>    <a href="carExpenses?carNumber=<s:property value="carNumber"/>" role="button" ><i class="icon-info-sign"></i></a>
          </td>
        </tr>
        </s:iterator>
