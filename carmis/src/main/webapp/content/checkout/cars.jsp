...
<body>
   ...
   <a href="showChangeCar"><button class="btn">添加车辆</button></a>
  
	<form id="tab" action="cars?checkout='yes'" method="post" style="float:right;">
	<table><tr>
    ...
    <table class="table">
      ...
      <tbody>
        <s:iterator value="cars" status="index">
          ...
          <td>
             <a href="showCheckout?carId=<s:property value="carId"/>" role="button" ><i class="icon-ok-sign"></i></a></td> 
